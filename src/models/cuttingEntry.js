...
//     // Calculate MTR per piece based on product type
//     const meterPerPiece = this.productType === 'Top' ? 1.5 : 1.2;

//     // Total MTR needed
//     this.totalMtr = this.totalPcs * meterPerPiece;

//     // Used MTR (same as totalMtr)
//     this.usedMtr = this.totalMtr;

//     // Diff MTR = Stock - Used
//     this.stockAfter = Math.max(0, this.stockBefore - this.totalMtr);

//     // Remaining MTR after cutting
//     this.diffMtr = Math.max(0, this.stockBefore - this.totalMtr);

// });


// // Indexes
// // cuttingEntrySchema.index({ trnNo: 1 }, { unique: true });
...
//     const allowedSizes =
//         this.productType === 'Top' ? SIZE_TOP : SIZE_BOTTOM;
